...
namespace Nach0.Decor.GenerateTypes.InvertedStairsCorner
{
    ...
    {
        public const string NAME = "InvertedStairsCorner";
    ...
    public class TypeBase : CSType
    {
        ...
        {
            GenerateTypeConfig.NAME, GenerateTypeConfig.MODNAME, LocalGenerateConfig.PARENT_NAME, "e", LocalGenerateConfig.NAME, "b"
        };
