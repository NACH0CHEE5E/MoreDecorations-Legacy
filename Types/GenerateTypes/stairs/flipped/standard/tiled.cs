...
namespace MoreDecorations.Types.GenerateTypes.Stairs
{
    ...
    class FlippedStairsTiled
    {

        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.flippedstairs.tiled")]
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.flippedstairs.tiled")]
