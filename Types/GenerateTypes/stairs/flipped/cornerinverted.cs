...
namespace Nach0.Decor.GenerateTypes.InvertedStairsCornerInverted
{
    public class LocalGenerateConfig
    {
        public const string NAME = "InvertedStairsCornerInverted";
        public const string PARENT_NAME = Stairs.LocalGenerateConfig.PARENT_NAME;
    }
    ...
    public class TypeBase : CSType
    {
        ...
        {
            GenerateTypeConfig.NAME, GenerateTypeConfig.MODNAME, LocalGenerateConfig.PARENT_NAME, "f", LocalGenerateConfig.NAME, "b"
        };
