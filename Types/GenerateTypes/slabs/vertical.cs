...
namespace MoreDecorations.Types.GenerateTypes.Slabs
{
    ...
    class VerticalSlabs
    {
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AddItemTypes, "Nach0.MoreDecorations.GenerateTypes.slabs.vertical")]
        static void generateTypes(Dictionary<string, ItemTypeRaw> types)
        {
            var i = 0;
            var type = "verticalslab";
            ...
            while (i < GenerateTypeConfig.standardList.Length)
            {
                ...
                types.Add(typeName, new ItemTypeRaw(typeName, new JSONNode()
                     .SetAs("categories", new JSONNode(NodeType.Array)
                        ...
                        .AddToArray(new JSONNode("vertical"))
        ...
        [ModLoader.ModCallback(ModLoader.EModCallbackType.AfterStartup, "Nach0.MoreDecorations.GenerateRecipes.slabs.vertical")]
        public static void RegisterRecipes()
        {
            var i = 0;
            var type = "verticalslab";
            var jobType = "VerticalSlab";
